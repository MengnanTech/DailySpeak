...
final class VoiceManager {
    ...
    let availableVoices: [VoiceOption] = [
        ...
        VoiceOption(id: "Xb7hH8MSUJpSbSDYk0k2", name: "Alice", gender: "female", accent: "British", description: "Clear, Engaging Educator", previewURL: URL(string: "https://storage.googleapis.com/eleven-public-prod/premade/voices/Xb7hH8MSUJpSbSDYk0k2/2e1ec1e6-55d1-4849-acbb-7df423776498.mp3")),
        VoiceOption(id: "pFZP5JQG7iQjIQuC4Bku", name: "Lily", gender: "female", accent: "British", description: "Velvety Actress", previewURL: URL(string: "https://storage.googleapis.com/eleven-public-prod/premade/voices/pFZP5JQG7iQjIQuC4Bku/0ab97b66-538d-449f-be7e-16ec2a385a2d.mp3")),
        ...
        VoiceOption(id: "JBFqnCBsd6RMkjVDRZzb", name: "George", gender: "male", accent: "British", description: "Warm, Captivating Storyteller", previewURL: URL(string: "https://storage.googleapis.com/eleven-public-prod/premade/voices/JBFqnCBsd6RMkjVDRZzb/5587cbb4-e4c9-4630-b42b-3a8f9dda8e0d.mp3")),
        ...
        VoiceOption(id: "nPczCjzI2devNBz1zQrb", name: "Brian", gender: "male", accent: "American", description: "Deep, Resonant and Comforting", previewURL: URL(string: "https://storage.googleapis.com/eleven-public-prod/premade/voices/nPczCjzI2devNBz1zQrb/f2ede70e-b5f3-4b8a-9192-a09f52a5e79c.mp3")),
        VoiceOption(id: "IKne3meq5aSn9XLyUdCD", name: "Charlie", gender: "male", accent: "Australian", description: "Deep, Confident, Energetic", previewURL: URL(string: "https://storage.googleapis.com/eleven-public-prod/premade/voices/IKne3meq5aSn9XLyUdCD/b0548dab-bdb0-4e80-9c6f-cd6c03e8fb41.mp3")),
